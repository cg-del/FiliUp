...
interface MultipleChoiceActivityProps {
  questions: Question[];
  title: string;
  onComplete: (score: number, percentage: number, answers: number[], timeSpentSeconds: number) => void;
}
...
export const MultipleChoiceActivity: React.FC<MultipleChoiceActivityProps> = ({
  ...
  useEffect(() => {
    // Add no-select to body and enter fullscreen
    ...
    return () => {
      // Cleanup: remove class and exit fullscreen
